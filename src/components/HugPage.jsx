  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
      ...
      >
        ...
        >
          "You can Assume that this is me crying" <br />I don’t need anything
          fancy right now…
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 15 }}
        ...
        >
          ✨ “ just my old mishthi who always loves to tease me… and honestly,
          those little taunts mean more to me than any praise. That’s all I
          want.💕” "I don’t like ki tu mere se naraz rahe or mai naraz rehne du
          aapko, jab tak nahi maanti tab tak manata rahunga because you are very
          special to me naa 💕”
        </motion.p>
      </motion.div>
      ...
      >
        ...
        <span className="relative z-10">one more try</span>
      </motion.button>
